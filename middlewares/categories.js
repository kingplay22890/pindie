...
const findCategoryById = async (req, res, next) => {
  ...
  try {
    ...
    next();
        ...
        res.status(400).send({ message: "Категория не найдена" });
  }
};
...
module.exports ={findAllCategories, findCategoryById, createCategory, checkIsCategoryExists, checkEmptyName, updateCategory, deleteCategory} ;